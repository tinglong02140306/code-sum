...
Update: 2016-11-25 09:11:25 GMT+0800
*/
(function e(t, n, r) {
    function s(o, u) {
        if (!n[o]) {
            ...
            var Component = Observable.extend({
                ...
                _render: function() {
                    ...
                    if (that.template) {
                        ...
                        newElement = $(that.template(that.options))[0];
        ...
        function(require, module, exports) {
            ...
            var DataSource = Observable.extend({
                ...
                _params: function(data) {
                    ...
                    // 处理gsb服务 对参数p jsonParams中的currentPageNo进行处理
                    if (options.hasOwnProperty('p')) {
                        var p = fly.evalJSON(options.p),
                            jsonParams = fly.evalJSON(p.jsonParams);
                        if (!!jsonParams.pageSize) {//分页的接口，对数据进行处理
                            jsonParams.currentPageNo = options.currentPageNo;
                            p.jsonParams = fly.toJSON(jsonParams);
                            options.p = fly.toJSON(p);
                        }
                    };
    ...
    14: [
        function(require, module, exports) {
            ...
            var CHANGE = "change",
                ...
                BROKEN_BACK_NAV = fly.support.browser.ie,
                hashStrip = /^#*/,
                optionalParam = /\((.*?)\)/g,
                namedParam = /(\(\?)?:\w+/g,
                splatParam = /\*\w+/g,
    ...
    17: [
        function(require, module, exports) {
            ...
            // 正则表达式
            var rclass = /[\t\r\n\f]/g,
                // nonBreakingSpaceRegExp = /\u00A0/g, // 不换行空格，例如&nbsp;
