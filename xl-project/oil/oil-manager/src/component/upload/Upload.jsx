...
class Upload extends React.Component {
    ...
    render() {
        ...
        let accept = type===1?image:type===2?video:type===3?txt:"";
        return <div className="upload-container">
            ...
            <div className="upload-file-box" style={{display:(type===1||type===2)&&file?"flex":"none"}}>
            ...
            <div style={{display:type===3&&file?"flex":"none"}}>
                {file_name}
            </div>
        </div>;
    }
...
Upload.propTypes = {
    type:PropTypes.number,//类型 1:图片 2:视频 3:文本文件 4其他
