...
<head>
    ...
    <link href="${ctx}/resource/h5/css/remove-car-app.css?ts<%=System.currentTimeMillis()%>" rel="stylesheet" />
    <title>一键挪车</title>
</head>
<body>
    <!-- 用户ID -->
                ...
                <form id="carForm" class="bf">
                    ...
                    <div class="car-num-wrap clearfix">
                        ...
                        <div class="in-value fl">
                            ...
                            <!-- maxlength="6" -->
                            <input type="text" id="target" class="car-num fl"  name="carNum" data-bind="value: formdata.carPlateNum" placeholder="请输入车牌号码">
                            <span class="icon-camera hides" data-bind="click: orcEvt"></span>
    ...
    <script type="text/javascript" src="${ctx}/resource/h5/js/remove-car-app.js?ts<%=System.currentTimeMillis()%>"></script>
</body>
</html>