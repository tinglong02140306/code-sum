 ...
 * @Last Modified time: 2019-02-12 17:31:24
 */
                ...
                <el-row>
                    ...
                    <el-col :span="9" :push="3">
                        <el-form-item label="主办部门" prop="majorDept">
                            <el-select class="xzqhWt" v-model="ruleForm.majorDept" filterable :disabled="isDisabled" :popper-append-to-body="false">
        ...
        getDetailById(obj) {
            ...
            unit.ajaxMerPost('/znsj-web/event/getEventInfo', obj, function (res) {
                if (res.flag == true) {
                    ...
                    _that.ruleForm.majorDept = data.sponsorDept;
                    
                    if(data.coopDept) {
                        let cDept = data.coopDept;
                        _that.ruleForm.assitDept = cDept.split(',');
                    }
                    ...
                    if (result.flag == true) {
                        ...
                        if(_that.xzqhCount <= _that.defXzqhuCount) {
                            setTimeout(function () {
                                ...
                                if(_that.saveXzqh[_that.xzqhCount]) {
...
#oneThingInfo {
    ...
    .el-form-item__content .el-select--small,.el-form-item__content .el-input--small {
        width: 100% !important;
    }
    .ml-10{
        margin-left: -10px;
