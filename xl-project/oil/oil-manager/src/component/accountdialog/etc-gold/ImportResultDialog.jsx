...
class ImportResultDialog extends React.Component{
    ...
    onOk=()=>{
        this.props.goldStore.setIsShowLeadResuleDialog(false);
        this.props.goldStore.getAccountList(1, 18);
    ...
    render(){
        const {isShowLeadResuleDialog,isShowLeadResultLoading,uploadResult} = this.props.goldStore;
        return <Modal
            centered={true}
