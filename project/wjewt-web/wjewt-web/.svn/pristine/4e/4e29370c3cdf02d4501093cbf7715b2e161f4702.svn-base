...
$(function() {
    var bsdtSkinColor = '#4c72ff', // 主题色
        materialTemp = fly.template.compile(
            ...
            '           </thead>' +
            '           <tbody>' +
            '               <tr class="pdl25  bd-top-none bd-right-none bd-left-none">' +
            '                   <td class="border-b ptb pdl25">{{item.clmc}}</td>' +
            '                   {{if item.sfby === "1"}}' +
            '                   <td class="border-b ptb pdl25 c9d"><div class="floatr public-results mgr25 blue-bg" style="border: 1px solid' + bsdtSkinColor + '">必要</div></td>' +
            '                   {{else if item.sfby === "2"}}' +
            '                   <td class="border-b ptb pdl25 c9d"><div class="floatr public-results mgr25 blue-bg" style="border: 1px solid ' + bsdtSkinColor + '">容缺候补</div></td>' +
            '                   {{else if item.sfby === "3"}}' +
            '                   <td class="border-b ptb pdl25 c9d"><div class="floatr public-results mgr25 blue-bg" style="border: 1px solid ' + bsdtSkinColor + '">可选</div></td>' +
            '                   {{else }}' +
            '                   <td class="border-b ptb pdl25 c9d"><div class="floatr public-results mgr25 blue-bg" style="border: 1px solid ' + bsdtSkinColor + '">其他</div></td>' +
            '                   {{/if}}' +
            '               </tr>' +
            '           </tbody>' +
            '       </table>' +
            ...
            '                       {{else if fj.fileBusiType =="MATERIAL_SAMPLE"}}材料样表{{/if}}</a>' +
            '                       </div>' +
            '                   {{/each}}' +
            '                   </td>' +
            '               </tr>' +
                    ...
                    success: function (data) {
                        ...
                        if (data) {
                            ...
                            if (data.sfbz && data.sfsf !== '否') {
                                ...
                                util.id('sfbz').innerHTML = data.sfbz;
                            }
                            if (data.cnbjqx) {
