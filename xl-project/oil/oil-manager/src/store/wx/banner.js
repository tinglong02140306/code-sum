...
class BannerStore {
    ...
    @action getResourceList(params){
        ...
        http.post('/website/resource/query-banner',params,response=>{
    ...
    //     this.isLoadingTable = true;
    //     this.params = params;
    //     params.purpose = isEmpty(params.purpose)?null:params.purpose;
    //     http.post('/website/resource/query-banner',params,response=>{
    //         this.isLoadingTable = false;
    //         const pagination = {};
    //         pagination.total = response.amount;
    ...
    @action delectBannerResorce(id){
        http.post('/website/resource/remove-banner',{id:id},response=>{
            message.info("删除成功");
