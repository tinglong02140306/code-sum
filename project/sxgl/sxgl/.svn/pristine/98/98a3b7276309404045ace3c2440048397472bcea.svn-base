 ...
 * @Last Modified time: 2019-01-28 15:38:55
 */
<template>
    <div>
        <Menu ref="contactMenu" :mode="mode" :open-names="openName" :active-name="menuState" @on-select="selectEvt" width="180" @on-open-change="openChange" v-show="!showNav">
