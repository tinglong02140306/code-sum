...
export default {
    ...
    methods: {
        ...
        printReceipt() {
            let that = this,
                param = that.$route.query,
                url = that.$store.state.path + '/consignee/printReceipt?id=' + param.receiptNo + '&type=' + param.type;
        ...
        printCirculation() {
            let that = this,
                param = that.$route.query,
                url = this.$store.state.path + '/consignee/printFlow?id='  + param.receiptNo + '&type=' + param.type;
            unit.openFullWindow(url, '');
        },
        /*
         * 图片预览  暂时路径跳转
