 ...
 * @author xysheng
 * @update 2016-01-25
 * @description 修改说明，默认是不调用下拉刷新的，当用户配置（noPullDown:true）下拉刷新接口才可以调用
 */
/*!
...
iScroll.prototype = {
    ...
    _pos: function(x, y) {
        ...
        if (this.options.useTransform) {
            if (y > 0 && this.options.noPullDown) {
                this.scroller.style[transform] = 'translate(0,0) scale(' + this.scale + ')' + translateZ;
