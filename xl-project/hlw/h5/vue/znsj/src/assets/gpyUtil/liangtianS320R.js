...
;(function () {
    ...
    var liangtianS320R = function (options) {
        this.defaultOpts = {
            viewfinderTemp: {
                elementTag: 'object',
                attrList: [{
    ...
    liangtianS320R.prototype = {
        constructor: liangtianS320R,
        init: function () {
            this.create();
        },
        create: function () {
    ...
    window.hspDeviceList.liangtianS320R = function (options) {
        return new liangtianS320R(options);
    }
})();