 ...
 * @Last Modified time: 2019-02-13 20:50:05
 */
            ...
            <el-row>
                ...
                <el-col :span="9" :push="3">
                    <el-form-item label="所属部门" prop="deptCode" :required="ruleForm.deptCode == '' ? false : true">
                        <el-select v-model="ruleForm.deptCode" filterable :disabled="isDisabled" class="xzqhWt selectArea" :popper-append-to-body="false">
            ...
            <el-row>
                ...
                <el-col :span="9" :push="1">
                    <el-form-item label="事项类型" prop="matterType" :required="ruleForm.matterType == '' ? false : true">
                        <el-select v-model="ruleForm.matterType" filterable :disabled="isDisabled" class="xzqhWt selectArea" :popper-append-to-body="false">
                        ...
                        <el-row class="mt10 person-select">
                            <el-col :span="9" :push="2" class='ml-10'>
                                <el-form-item label="个人主题" prop="personalTheme" :required="ruleForm.personalTheme == '' ? false : true">
                                    <el-select v-model="ruleForm.personalTheme" multiple filterable :disabled="isDisabledPersonal" :popper-append-to-body="false">
                            ...
                            <el-col :span="9" :push="6" class='ml-10'>
                                <el-form-item label="个人对象" prop="personalObject" :required="ruleForm.personalObject == '' ? false : true">
                                    <el-select v-model="ruleForm.personalObject" multiple filterable :disabled="isDisabledPersonal" :popper-append-to-body="false">
                        ...
                        <el-row class="mt10 legal-select">
                            <el-col :span="9" :push="2" class='ml-10'>
                                <el-form-item label="法人主题" prop="legalTheme" :required="ruleForm.legalTheme == '' ? false : true">
                                    <el-select v-model="ruleForm.legalTheme" multiple filterable :disabled="isDisabledLegal" :popper-append-to-body="false">
                            ...
                            <el-col :span="9" :push="6" class='ml-10'>
                                <el-form-item label="法人对象" prop="legalObject" :required="ruleForm.legalObject == '' ? false : true">
                                    <el-select v-model="ruleForm.legalObject" multiple filterable :disabled="isDisabledLegal" :popper-append-to-body="false">
