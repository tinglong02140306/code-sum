 ...
 * @Last Modified time: 2019-02-15 15:15:38
 */
...
<template>
    ...
    <div id="receiptConfig">
        ...
        <div class="main-wrap  clearfix">
            ...
            <el-dialog title="事项导入" :visible.sync="importFileVis" width="700px" height="430px" custom-class="import-dialog" :close-on-click-modal="false">
                <div class="import-wrap" v-show="!isImportSuccess">
                    <div class="import-file-wrap fl">
                        ...
                        <div class="progress-wrap">
                            ...
                            <p class="file-infos">
                                <i class="icon-mark"></i>
                                <span :title="fileList.name" style="color:#137ddf;">{{fileList.name}}</span>
                ...
                <div class="import-result-wrap" v-show="isImportSuccess">
                    <p class="content">
                        ...
                        <span class="font">共{{loadInfo.total}}条记录，导入成功{{loadInfo.sucessNum}}条，导入失败
                            <i class="font" :class="loadInfo.failNum==0?'cursorDef':''" @click="downloadImportResult(loadInfo.resFileId,loadInfo.failNum)">{{loadInfo.failNum}}</i>条</span>
                    </p>
                </div>
                <div class="footer" v-show="isImportSuccess">
                    <!--@click="sureImportEvt" :disabled="uploadPer == 100 ? false: true" -->
...
export default {
    ...
    methods: {
        ...
        downloadImportResult(fileName,failNum) {
            if(failNum == 0){
                return;
            }else{
