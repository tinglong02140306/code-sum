        ...
        <div class="search-matters">
            ...
            <div class="main-wrap clearfix">
                ...
                <Row class="search-wrap">
                    ...
                    <Col :span="5">
                    <label class="inline-block mr10">事件名称</label>
                    <div class="inline-block obj-width">
                        <el-input v-model="matterName" :maxlength="100" placeholder="请输入事件名称" size="small" @change="changeMatterName"></el-input>
                    </div>
                    </Col>
                    <Col span="4" style="float: left;" class="clearfix">
                    <Button style="float: left;" type="primary" class="chaxun h30" @click="searchEvt">查询</Button>
                ...
                <div class="mt10 clearfix" v-if="isHigRow">
                    <Row>
                        ...
                        <Col :span="5">
                        <label class="inline-block mr10">事件编码</label>
                        <div class="inline-block obj-width">
                            ...
                            <el-table-column type="expand" prop="childs" label="" width="40">
                                <template scope="scope">
                                    <el-table :data="scope.row.childs" tooltip-effect="dark" :show-header="false">
                                        <el-table-column label="事件名称" width="310" prop="eventName" show-overflow-tooltip>
                                        </el-table-column>
        ...
        getMattData() {
            let _that = this,
                jsonObj = {
                    ...
                    sponsorDept: _that.deptVal === 'all' ? '' : _that.deptVal,//部门编码
