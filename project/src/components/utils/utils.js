...
(function($) {
    ...
    $.getTranslate = function(el, axis) {
        ...
        if (axis === 'x') {
            ...
            //Crazy IE10 Matrix
            else if (matrix && matrix.length === 16)
                curTransform = parseFloat(matrix[12]);
            //Normal Browsers
            else
                curTransform = parseFloat((matrix && matrix.length ==5) ? matrix[4] : 0);
        }
        if (axis === 'y') {
            //Latest Chrome and webkits Fix
            if (window.WebKitCSSMatrix)
            ...
            //Normal Browsers
                ...
                curTransform = parseFloat((matrix && matrix.length == 6) ? matrix[5] : 0);
        }
