...
class PartnerStationDialog extends Component {
    ...
    componentDidMount() {
        this.props.BillTicketStore.getCompanyQuery();
        ...
        this.props.BillTicketStore.getStationQuery(params);
    }
    ...
    handleTableChange = (pagination) => {
        ...
        this.props.BillTicketStore.setSearchPagination(pager);
    ...
    selectCompanyOption=()=>{
        const {companyList} = this.props.BillTicketStore;
    ...
    onCancel=()=>{
        this.props.BillTicketStore.setIsShowSearchDialog(false);
    }

    onOk=()=>{
        const {stationList,typeModal} = this.props.BillTicketStore;
        const {selectedRowKeys} = this.state;
        const key = selectedRowKeys[0];
        if (typeModal === 3){
            this.props.BillTicketStore.setSearchData(stationList[key]);
        } else {
            this.props.BillTicketStore.setOperationData(stationList[key]);
        }
        this.props.BillTicketStore.setIsShowSearchDialog(false);
    }

    render() {
        const {isShowSearchLoading,searchPagination,stationList,isShowSearchDialog} = this.props.BillTicketStore;
