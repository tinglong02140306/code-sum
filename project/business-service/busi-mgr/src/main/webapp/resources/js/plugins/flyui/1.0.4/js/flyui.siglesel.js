define([
    ...
    var siglesel = fly.ui.Widget.extend({
        ...
        ctor: function (element, options) {
            ...
            //逐个选中
            that.element.on('click', 'span', function () {
        ...
        _template: function () {
            ...
            this.itemTemplate = fly.template(
                ...
                '<span {{if checked}}class="checked"{{/if}} data-uid="{{uid}}" title="{{' + options.textField + '}}"><i class="ico ico-sigle"></i>{{' + options.textField + '}}</span>');
        },
