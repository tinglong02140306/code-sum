...
module.exports = {
    ...
    dev: {
        ...
        proxyTable: {
            //收件配置
            '/bog-situation-mgr/': {
                // target: "http://10.5.41.199:9170/bog-situation-mgr",
                target: "http://10.5.40.243:9170/bog-situation-mgr", 
                // target: "http://172.31.1.87:9170/bog-situation-mgr", 
                changeOrigin: true,
                pathRewrite: {
                    '^/bog-situation-mgr': ''
                }
            ...
            //收件配置
            '/bog-matter-mgr/': {
                // target: "http://10.5.40.243:9270/sxgl",
                // target: "http://10.5.41.199:9270/bog-matter-mgr",
                target: "http://10.5.40.243:9270/bog-matter-mgr",
                // target: "http://172.31.1.87:9270/bog-matter-mgr", 
                changeOrigin: true,
                pathRewrite: {
                    '^/bog-matter-mgr': ''
                }
