...
(function e(t, n, r) {
    ...
    2: [
        function(require, module, exports) {
            ...
            var ComponentBindingTarget = BindingTarget.extend({
                ...
                binders: function() {
                    return componentBinders[this.target.name.toLowerCase()] || {};
                },
                    ...
                    if (!template) {
                        if (nodeName == "select") {
                            if (valueField || textField) {
                                template = '<option value="{{' + valueField || textField +
                                    '}}">' +
                                    textField || valueField + '</option>';
                            } else {
                    ...
                    if (this.bindings.template) {
                        ...
                        if (element.children.length) {
                            ...
                            for (idx = 0, length = source.length; idx < length; idx++) {
                                bindElement(element.children[idx], source[idx], [source[idx]]
                                    .concat(
                                        parents));
                            }
                        }
            ...
            function bindElement(element, source, parents) {
                ...
                if (bind) {
                    ...
                    if (!target) {
                        options = utils.parseOptions(element, {
                            textField: '',
                            valueField: '',
                            template: '',
                            valueUpdate: CHANGE,
    ...
    5: [
        function(require, module, exports) {
            ...
            var Component = Observable.extend({
                ...
                render: function() {
                    ...
                    if (this.template) {
                        ...
                        newElement = $(this.template(this.options))[0];
                ...
                _setAttribute: function() {
                    ...
                    $.each(this.attrs, function(key, value) {
                        if (key == 'class') {
                            var newClass = element.getAttribute(key);
                            if (newClass) value = newClass + ' ' + value;
                        }
                ...
                destroy: function() {
                    var element = this.element;
                    fly.deleteExpando(element, NS + this.name);
            ...
            ui.component = function(element, options, role) {
                ...
                var keyName = 'fly' + component.fn.name;
                ...
                options = $.extend({}, utils.parseOptions(element, component.fn.options),
                    options);
             ...
             */
            fly.component = function(newComponent) {
                var name = newComponent.fn.name;
                fly.ui[name.toLowerCase()] = newComponent;
            };
    ...
    6: [
        function(require, module, exports) {
            ...
            var $ = require('./fly.jquery');
            var ajax = require('./fly.ajax');

            // class-shim
            var Class = require('./fly.class');
            ...
            fly.win = win;
            fly.Class = Class;
            fly.support = $.extend(support, $.support);
            fly.ui = {
                roles: {},
                defaults: {}
            };
            ...
            fly.getter = function(expression, safe) {
                ...
                /*var expressions = expression.split(roperator);*/

                /*return getterCache[key] = getterCache[key] ||
        new Function('d', 'return ' + $.map(expressions, function(item){
        if(rexpression.test(item)) {
            return fly.expr(item, safe);
        } else if(item) {
            return item;
        }
    }).join(''));*/
            ...
            var NodeDataSource = DataSource.extend({
                ...
                _find: function(method, value, key) {
                    ...
                    for (idx = 0, length = data.length; idx < length; idx++) {
                        ...
                        node = children[method](value, key);
    ...
    8: [
        function(require, module, exports) {
            ...
            fly.evalJSON = function(src) {
                ...
                if (typeof(JSON) === 'object' && JSON.parse && !fly.browser.ie) {
    ...
    9: [
        function(require, module, exports) {
            ...
            jQuery.parseHTML = function(data) {
                ...
                var context = support.createHTMLDocument ?
    ...
    12: [
        function(require, module, exports) {
            ...
            var ObservableObject = Observable.extend({
                 ...
                 * @returns {Boolean}
                 */
                shouldSerialize: function(field, keepUid) {
                    var serialize = this.hasOwnProperty(field) &&
                        field !== "_events" &&
                        field !== "_super" &&
                        typeof this[field] !== FUNCTION;

                    return keepUid ? serialize : (serialize && field !== "uid");
                },
    ...
    13: [
        function(require, module, exports) {
            ...
            window.require = scrat;
            window.define = scrat.define;
            window.defineCSS = scrat.defineCSS;
    ...
    17: [
        function(require, module, exports) {
            ...
            // 正则表达式
            var nonBreakingSpaceRegExp = /\u00A0/g, // 不换行空格，例如&nbsp;
                exponentRegExp = /[eE][\-+]?[0-9]+/, // 科学记数法
             ...
             */
            utils.parseOptions = function(element, options) {
                var result = {},
                    option,
                    value;
             ...
             */
            utils.caret = function(element, start, end) {
                var rangeElement;
             ...
             */
            utils.selectRange = function(element, start, end) {
                var range;
                element = element[0] || element;
