...
;(function () {
    ...
    var liangtianXF660R = function (options) {
        this.defaultOpts = {
            viewfinderTemp: {
                elementTag: 'object',
                attrList: [{
    ...
    liangtianXF660R.prototype = {
        constructor: liangtianXF660R,
        init: function () {
            this.create();
        },
        create: function () {
    ...
    window.hspDeviceList.liangtianXF660R = function (options) {
        return new liangtianXF660R(options);
    }
})();